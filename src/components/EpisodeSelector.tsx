      ...
      {activeTab === 'episodes' && (
        <>
          ...
          <div className='flex items-center gap-4 mb-4 border-b border-gray-300 dark:border-gray-700 -mx-6 px-6 flex-shrink-0'>
            ...
            {/* 向上/向下按钮 */}
            <button
              className='flex-shrink-0 w-8 h-8 rounded-md flex items-center justify-center text-gray-700 hover:text-theme-primary hover:bg-theme-primary-soft/60 dark:text-gray-300 transition-colors transform translate-y-[-4px]'
              onClick={() => {
                // 切换集数排序（正序/倒序）
              ...
              <div className='flex-1 overflow-y-auto space-y-2 pb-20'>
                                ...
                                if (!videoInfo.hasError) {
                                  return (
                                    <div className='flex items-end gap-3 text-xs'>
                                      <div className='text-theme-primary font-medium text-xs'>
                                        {videoInfo.loadSpeed}
                                      </div>
                ...
                <div className='flex-shrink-0 mt-auto pt-2 border-t border-gray-400 dark:border-gray-700'>
                  <button
                    ...
                    className='w-full text-center text-xs text-gray-500 dark:text-gray-400 hover:text-theme-primary transition-colors py-2'
                  >
                    影片匹配有误？点击去搜索
                  </button>
                </div>
