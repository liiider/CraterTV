      ...
      <div className='pt-4'>
        ...
        <div className='min-h-[100px] sm:min-h-[120px] flex items-center justify-center'>
          <div className='flex items-center gap-3 sm:gap-4 text-gray-500 dark:text-gray-400'>
            <div className='w-5 h-5 sm:w-6 sm:h-6 border-2 border-gray-300 border-t-theme-primary rounded-full animate-spin'></div>
      ...
      <div className='mb-3 flex items-center justify-between'>
        ...
        {currentPlayingIndex !== -1 && (
          <button
            ...
            className='flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-1.5 sm:py-2 text-xs font-medium text-gray-600 dark:text-gray-400 hover:text-theme-primary bg-gray-300/50 dark:bg-gray-800 hover:bg-theme-primary-soft/60 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-theme-primary/30 transition-all duration-200'
            title='滚动到当前播放位置'
          >
            ...
            return (
              <div
                ...
                className={`flex-shrink-0 w-36 sm:w-48 p-2 sm:p-3 rounded-lg border transition-all duration-200 flex flex-col min-h-[100px] sm:min-h-[120px] ${
                  isPlaying
                    ? 'bg-theme-primary-soft/70 border-theme-primary/30'
                    : isFinishedProgram
              ...
              >
                ...
                {isPlaying && (
                  <div className='mt-auto pt-1 sm:pt-2 flex items-center gap-1 sm:gap-1.5 flex-shrink-0'>
                    <div className='w-1.5 h-1.5 sm:w-2 sm:h-2 bg-theme-primary rounded-full animate-pulse'></div>
