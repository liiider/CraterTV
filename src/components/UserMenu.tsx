...
export const UserMenu: React.FC = () => {
  ...
  const menuPanel = (
    <>
      ...
      {/* 菜单面板 */}
      <div className='fixed top-14 right-4 w-56 bg-theme-surface rounded-lg shadow-xl z-[1001] border border-theme-border overflow-hidden select-none'>
        {/* 用户信息区域 */}
  ...
  const settingsPanel = (
    <>
      ...
      {/* 设置面板 */}
      <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-xl max-h-[90vh] bg-theme-surface rounded-xl shadow-xl z-[1001] flex flex-col'>
        {/* 内容容器 - 独立的滚动区域 */}
        <div
          ...
          <div className='space-y-6'>
                  ...
                  <div className='absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-h-60 overflow-auto'>
                    {doubanDataSourceOptions.map((option) => (
                      ...
                      >
                        ...
                        {doubanDataSource === option.value && (
                          <Check className='w-4 h-4 text-theme-primary flex-shrink-0 ml-2' />
                        )}
                      </button>
                    ))}
                  </div>
            ...
            {doubanDataSource === 'custom' && (
              <div className='space-y-3'>
                ...
                <input
                  type='text'
                  className='w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-theme-primary focus:border-theme-primary transition-all duration-200 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 shadow-sm hover:border-gray-400 dark:hover:border-gray-500'
            ...
            <div className='flex items-center justify-between'>
              ...
              <label className='flex items-center cursor-pointer'>
                <div className='relative'>
                  ...
                  />
                  <div className='w-11 h-6 bg-theme-border rounded-full peer-checked:bg-theme-primary transition-colors'></div>
  ...
  const changePasswordPanel = (
    <>
      ...
      {/* 修改密码面板 */}
      <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-theme-surface rounded-xl shadow-xl z-[1001] overflow-hidden'>
        {/* 内容容器 - 独立的滚动区域 */}
        <div
        ...
        >
          ...
          <div className='space-y-4'>
            ...
            <div>
              ...
              <input
                type='password'
                className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-theme-primary focus:border-transparent transition-colors bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400'
                placeholder='请输入新密码'
                value={newPassword}
          ...
          <div className='flex gap-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700'>
            ...
            <button
              ...
              className='flex-1 px-4 py-2 text-sm font-medium text-white bg-theme-primary hover:bg-theme-primary-hover rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed'
