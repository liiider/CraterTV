            ...
            {showConfirm && onConfirm ? (
              <>
                ...
                <button
                  ...
                  className='px-4 py-2 text-sm font-medium text-white bg-theme-primary hover:bg-theme-primary-hover rounded-lg transition-colors'
                >
                  {confirmText}
                </button>
              </>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          ...
          <div className='border border-gray-200 dark:border-gray-700 rounded-lg p-6 bg-white dark:bg-gray-800 hover:shadow-sm transition-shadow flex flex-col'>
            <div className='flex items-center gap-3 mb-6'>
              <div className='w-8 h-8 rounded-lg bg-theme-primary-soft flex items-center justify-center'>
              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <input
                    ...
                    className='w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-theme-primary focus:border-theme-primary transition-colors'
