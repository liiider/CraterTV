...
function SearchPageClient() {
  ...
  return (
    <PageLayout activePath='/search'>
          ...
          <form onSubmit={handleSearch} className='max-w-2xl mx-auto'>
            <div className='relative'>
              ...
              <input
                ...
                autoComplete='off'
                className='w-full h-12 rounded-lg bg-theme-surface/80 py-3 pl-10 pr-12 text-sm text-theme-foreground placeholder:text-theme-muted focus:outline-none focus:ring-2 focus:ring-theme-primary/60 focus:bg-theme-surface border border-theme-border shadow-sm'
              />
                ...
                <h2 className='text-xl font-bold text-gray-800 dark:text-gray-200'>
                  ...
                  {isLoading && useFluidSearch && (
                    <span className='ml-2 inline-block align-middle'>
                      <span className='inline-block h-3 w-3 border-2 border-theme-border border-t-theme-primary rounded-full animate-spin'></span>
                    </span>
                  )}
                </h2>
              </div>
              ...
              <div className='mb-8 flex items-center justify-between gap-3'>
                ...
                <label className='flex items-center gap-2 cursor-pointer select-none shrink-0'>
                  ...
                  <div className='relative'>
                    ...
                    />
                    <div className='w-9 h-5 bg-theme-border rounded-full peer-checked:bg-theme-primary transition-colors'></div>
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-20 md:bottom-6 right-6 z-[500] w-12 h-12 bg-theme-primary/90 hover:bg-theme-primary-hover text-white rounded-full shadow-lg backdrop-blur-sm transition-all duration-300 ease-in-out flex items-center justify-center group ${
          showBackToTop
