        ...
        >
          ...
          >
            <div className='flex justify-between items-start mb-4'>
              <h3 className='text-2xl font-bold tracking-tight text-theme-foreground border-b border-theme-primary pb-1'>
                提示
              </h3>
              <button
            ...
            <div className='mb-6'>
              <div className='relative overflow-hidden rounded-lg mb-4 bg-theme-primary-soft/70'>
                <div className='absolute inset-y-0 left-0 w-1.5 bg-theme-primary'></div>
            ...
            <button
              onClick={() => handleCloseAnnouncement(announcement)}
              className='w-full rounded-lg bg-theme-primary px-4 py-3 text-white font-medium shadow-md hover:shadow-lg hover:bg-theme-primary-hover transition-all duration-300 transform hover:-translate-y-0.5'
            >
              我知道了
            </button>
          </div>
